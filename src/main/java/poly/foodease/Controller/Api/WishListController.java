...
public class WishListController {
    ...
    public ResponseEntity<WishListResponse> addFoodToWishList(@PathVariable Integer wishListId,
        ...
        return ResponseEntity.ok(wishListService.addFoodToWishList(wishListId, foodId));
    }
    ...
    public ResponseEntity<List<Foods>> getFoodsByWishList(@PathVariable Integer wishListId) {
        List<Foods> foods = wishListService.getFoodsByWishList(wishListId);
